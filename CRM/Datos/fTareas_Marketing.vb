...
Public Class fTareas_Marketing
    ...
    Public Function Mostrar() As DataTable  'Funcion Mostrar
        Try
            ConexionDB()
            ComandoSQL = New SqlCommand("MostrarTareas")
    ...
    Public Function Insertar(TablaDatos As eTareas_Marketing) As Boolean 'Funcion Insertar
        Try
            ConexionDB()
            ComandoSQL = New SqlCommand("InsertarTarea")
            ComandoSQL.CommandType = CommandType.StoredProcedure
            ComandoSQL.Connection = Connect
    ...
    Public Function Actualizar(TablaDatos As eTareas_Marketing) As Boolean 'Funcion Actualizar
        Try
            ConexionDB()
    ...
    Public Function Eliminar(TablaDatos As eTareas_Marketing) As Boolean 'Funcion Eliminar
        Try
            ConexionDB()
            ComandoSQL = New SqlCommand("EliminarTarea")
            ComandoSQL.CommandType = CommandType.StoredProcedure
